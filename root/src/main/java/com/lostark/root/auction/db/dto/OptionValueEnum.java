...
public enum OptionValueEnum {
    ...
    IMPRESS_POWER_8(44, 360, "3.60%", 1, 3),
    IMPRESS_POWER_9(44, 460, "4.60%", 2, 3),
    IMPRESS_POWER_10(44, 480, "4.80%", 4, 2),
    IMPRESS_POWER_11(44, 560, "5.60%", 3, 3),
    IMPRESS_POWER_12(44, 800, "8.00%", 4, 3),

    // 무기 공격력 %
    WEAPON_ATTACK_PERCENT(46, 36, "0.36%", 1, 1),
    WEAPON_ATTACK_PERCENT_2(46, 46, "0.46%", 2, 1),
    WEAPON_ATTACK_PERCENT_3(46, 56, "0.56%", 3, 1),
    WEAPON_ATTACK_PERCENT_4(46, 80, "0.80%", 4, 1),
    ...
    WEAPON_ATTACK_PERCENT_10(46, 180, "1.80%", 4, 2),
    WEAPON_ATTACK_PERCENT_11(46, 210, "2.10%", 3, 3),
    WEAPON_ATTACK_PERCENT_12(46, 300, "3.00%", 4, 3),
    ...
    STATUS_ATTACK_DURATION_9(57, 50, "0.50%", 4, 2),
    STATUS_ATTACK_DURATION_10(57, 58, "0.58%", 2, 3),
    STATUS_ATTACK_DURATION_11(57, 70, "0.70%", 3, 3),
    STATUS_ATTACK_DURATION_12(57, 100, "1.00%", 4, 3),

    // 서폿 아이덴티티 획득량 증가
    SUP_IDENTITY_INCREASE(43, 72, "0.72%", 1, 1),
    SUP_IDENTITY_INCREASE_2(43, 90, "0.90%", 2, 1),
    SUP_IDENTITY_INCREASE_3(43, 111, "1.11%", 3, 1),
    SUP_IDENTITY_INCREASE_4(43, 160, "1.60%", 4, 1),
    SUP_IDENTITY_INCREASE_5(43, 162, "1.62%", 1, 2),
    SUP_IDENTITY_INCREASE_6(43, 207, "2.07%", 2, 2),
    SUP_IDENTITY_INCREASE_7(43, 252, "2.52%", 3, 2),
    SUP_IDENTITY_INCREASE_8(43, 270, "2.70%", 1, 3),
    SUP_IDENTITY_INCREASE_9(43, 345, "3.45%", 2, 3),
    SUP_IDENTITY_INCREASE_10(43, 360, "3.60%", 4, 2),
    SUP_IDENTITY_INCREASE_11(43, 420, "4.20%", 3, 3),
    SUP_IDENTITY_INCREASE_12(43, 600, "6.00%", 4, 3),

    // 아군 공격력 강화 효과
    SUP_TEAM_ATTACK_POINT_INCREASE(51, 60, "0.60%", 1, 1),
    ...
    SUP_TEAM_ATTACK_POINT_INCREASE_10(51, 300, "3.00%", 4, 2),
    SUP_TEAM_ATTACK_POINT_INCREASE_11(51, 352, "3.52%", 3, 3),
    SUP_TEAM_ATTACK_POINT_INCREASE_12(51, 500, "5.00%", 4, 3),

    //아군 피해량 강화 효과
    SUP_TEAM_DAMAGE_POINT_INCREASE(52, 90, "0.90%", 1, 1),
    SUP_TEAM_DAMAGE_POINT_INCREASE_2(52, 114, "1.14%", 2, 1),
    SUP_TEAM_DAMAGE_POINT_INCREASE_3(52, 138, "1.38%", 3, 1),
    SUP_TEAM_DAMAGE_POINT_INCREASE_4(52, 200, "2.00%", 4, 1),
    ...
    SUP_TEAM_DAMAGE_POINT_INCREASE_10(52, 450, "4.50%", 4, 2),
    SUP_TEAM_DAMAGE_POINT_INCREASE_11(52, 528, "5.28%", 3, 3),
    SUP_TEAM_DAMAGE_POINT_INCREASE_12(52, 750, "7.50%", 4, 3),

    // 적에게 주는 피해
    DAMAGE_TO_ENEMY(42, 24, "0.24%", 1, 1),
    DAMAGE_TO_ENEMY_2(42, 30, "0.30%", 2, 1),
    ...
    DAMAGE_TO_ENEMY_8(42, 90, "0.90%", 1, 3),
    DAMAGE_TO_ENEMY_9(42, 115, "1.15%", 2, 3),
    DAMAGE_TO_ENEMY_10(42, 120, "1.20%", 4, 2),
    DAMAGE_TO_ENEMY_11(42, 140, "1.40%", 3, 3),
    DAMAGE_TO_ENEMY_12(42, 200, "2.00%", 4, 3),
    ...
    CRITICAL_DAMAGE_5(50, 110, "1.10%", 4, 1),
    CRITICAL_DAMAGE_6(50, 138, "1.38%", 2, 2),
    CRITICAL_DAMAGE_7(50, 170, "1.70%", 3, 2),
    CRITICAL_DAMAGE_8(50, 179, "1.79%", 1, 3),
    CRITICAL_DAMAGE_9(50, 230, "2.30%", 2, 3),
    CRITICAL_DAMAGE_10(50, 240, "2.40%", 4, 2),
    CRITICAL_DAMAGE_11(50, 282, "2.82%", 3, 3),
    CRITICAL_DAMAGE_12(50, 400, "4.00%", 4, 3),
    ...
    PARTY_SHIELD_EFFECT_10(48, 210, "2.10%", 4, 2),
    PARTY_SHIELD_EFFECT_11(48, 245, "2.45%", 3, 3),
    PARTY_SHIELD_EFFECT_12(48, 350, "3.50%", 4, 3),
    ...
    PARTY_HEAL_EFFECT_10(47, 210, "2.10%", 4, 2),
    PARTY_HEAL_EFFECT_11(47, 245, "2.45%", 3, 3),
    PARTY_HEAL_EFFECT_12(47, 350, "3.50%", 4, 3),
